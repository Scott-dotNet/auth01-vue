    ...
    <el-container style="height: 100%; overflow: hidden">
      <el-aside width="auto">
        ...
        <div class="el-menu-box">
            ...
            >
            <el-icon :size="20"  color="green"><Opportunity /></el-icon>
            </div>
        ...
        <el-header class="headerCss">
          <div style="display: flex; height: 100%; align-items: center">
            <div
              ...
              "
            >
              <div class="logo-image" style="width: 32px; height: 32px">
                <el-icon :size="32"  color="green"><Opportunity /></el-icon>
              </div>
            ...
            >
              ...
              >
                <el-icon :size="20" color="black" ><UserFilled /></el-icon>
              </div>
              <div style="padding-left: 5px; padding-top: 3px">Scott</div>
            </div>
          </div>
        </el-header>
...
export default defineComponent({
  setup() {
    ...
    // 初始加载 DOM
    onMounted(() => {
      tabsList.value.push(routes[0]);// 默认加载第一个页面
